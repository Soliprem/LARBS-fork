#!/bin/sh
# Soli's Auto Rice Boostrapping Script (LARBS)
# by Soli , from Luke Smith <luke@lukesmith.xyz>
# License: GNU GPLv3
...
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/Soliprem/LARBS-fork/master/progs.csv"
